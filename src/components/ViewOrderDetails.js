  ...
  return (
    <div>
      {orderDetails ? (
        <div>
          <ListGroup>
            ...
            <ListGroupItem>
              ...
              <ListGroupItem>
                {" "}
                product name: {itemsData.itemsProductName}{" "}
              </ListGroupItem>
              <ListGroupItem>
                {" "}
                product qty: {itemsData.itemsProductQty}{" "}
              </ListGroupItem>
              <ListGroupItem>
                {" "}
                product weight: {itemsData.itemsProductWeight}{" "}
              </ListGroupItem>
            </ListGroupItem>
          </ListGroup>
        ...
        <div>The order was not found</div>
      )}
    </div>
  );
};
